...
### Theory
<b>Data preprocessing</b> is an essential step in data analysis.   
It involves transforming raw data into a more structured and meaningful format.  
...
Functions / Operations for <u>Data Binning</u>
1. Create Bins  
Function - `pd.cut()`  
...
Functions / Operations for <u>Data Formatting</u>  
1. Check Data Types  
Function - `dtypes`  
